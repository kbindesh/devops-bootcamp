...
- An **AWS Account** with _EC2 full access_ permission
...
- Connect to Jenkins server (ec2) over SSH &rarr; Run following commands to install **Java**:
...
# Check the current installed version of Jenkins
jenkins version
```
